...
class DashboardRouter extends BaseRoutes {
    routes(): void {
        ...
        this.router.get("/date/client", auth, DashboardController.getClientStatsFromDate);
        this.router.get("/date/product", auth,  DashboardController.getProductStatsFromDate);
